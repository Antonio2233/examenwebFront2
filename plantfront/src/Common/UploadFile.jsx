...
const UploadFile = ({setEventData}) => {
  ...
  const handleUpload = async () => {
    ...
    formData.append('upload_preset', 'Preset_AGZ');
    formData.append('cloud_name', 'dogvqrxom');

    try {
      const response = await axios.post(
        'https://api.cloudinary.com/v1_1/dogvqrxom/upload',
        formData
      );
      setLoading(false);
